    ...
    <div className="space-y-6">
      <div className="border-b border-gray-200 pb-5">
        <h1 className="text-2xl font-bold text-gray-900 tracking-tight flex items-center gap-2.5">
          ...
          <span className="text-xs bg-teal-50 text-teal-700 font-medium px-2 py-0.5 rounded-full border border-teal-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-2">
          <div className="text-[10px] uppercase font-bold text-purple-600 flex items-center gap-1.5">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-2">
          ...
          <div className={`text-2xl font-bold ${globalMetrics.profit >= 0 ? "text-emerald-600" : "text-red-600"}`}>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-2">
          <div className="text-[10px] uppercase font-bold text-blue-600 flex items-center gap-1.5">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-2">
          <div className="text-[10px] uppercase font-bold text-red-600 flex items-center gap-1.5">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-2">
          ...
          {qAnswers.bestCampaign ? (
            ...
            <div className="text-xs text-gray-400">Nenhuma campanha cadastrada.</div>
          )}
        </div>

        {/* 8. Qual oferta merece mais orçamento? */}
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-2">
          <div className="text-[10px] uppercase font-bold text-emerald-700 flex items-center gap-1.5">
            <TrendingUp className="w-3.5 h-3.5" />
          ...
          {qAnswers.bestOffer ? (
            ...
            <div className="text-xs text-gray-400">Sem dados de ofertas.</div>
          )}
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-2">
          ...
          {qAnswers.worstOffer ? (
            ...
            <div className="text-xs text-gray-400">Sem ofertas para pausar.</div>
          )}
        </div>

        {/* 10. De onde veio cada venda? */}
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-2 md:col-span-2 lg:col-span-3">
          <div className="text-[10px] uppercase font-bold text-purple-600 flex items-center gap-1.5">
          ...
          <div className="flex flex-wrap gap-3 pt-1">
            {qAnswers.origins.map(([origin, count]) => (
              <div key={origin} className="px-3 py-2 bg-gray-100 border border-gray-200 rounded-lg text-xs">
                <span className="text-gray-600 capitalize">{origin.replace("_", " ")}: </span>
                <strong className="text-gray-900 font-bold">{count} vendas</strong>
